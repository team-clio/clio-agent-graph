...
from clio_agent_graph.retrieval.ports import EmbeddingModel
...
def load_default_embedding_model() -> EmbeddingModel:
    ...
    if model_name.startswith("local:"):
        from clio_agent_graph.retrieval.local_embedding import LocalHashEmbeddingModel

        return LocalHashEmbeddingModel(model_name)
    if model_name.startswith("ollama:"):
        from clio_agent_graph.retrieval.ollama_embedding import OllamaEmbeddingModel
