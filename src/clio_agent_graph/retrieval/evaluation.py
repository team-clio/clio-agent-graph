...
from clio_agent_graph.matching.models import IssueRetrievalRequest, IssueRetrievalResponse
from clio_agent_graph.normalization.models import ContractModel, NonEmptyText
...
def main() -> int:
    ...
    if len(sys.argv) != 2:
        print("usage: python -m clio_agent_graph.retrieval.evaluation <cases.json>")
        return 2
